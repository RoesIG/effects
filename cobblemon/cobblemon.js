...
function wireEvents(){
  ...
  document.addEventListener('click',e=>{if(!e.target.closest('.species-search-wrap')){$('species-results').classList.remove('open');$('compare-results')?.classList.remove('open');}});
